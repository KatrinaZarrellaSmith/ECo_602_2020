...
Create a vector using sequential numbers with a mimimum and maximum increased by 1 unit in between using `:`. The increment can also be customized by using `seq()`.
